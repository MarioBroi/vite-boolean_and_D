            ...
            <div class="row">
                <div class="col-4">
                    <ul class="list-unstyled">
                        ...
                        <li><a href="" class="text-white text-decoration-none">Privacy policy</a>
                        </li>
                        <li><a href="" class="text-white text-decoration-none">Terms of service</a>
                        </li>
                ...
                <div class="col-4">
                    <ul class="list-unstyled">
                        <li><a href="" class="text-white text-decoration-none">Photosensitive
                                warning</a>
                        </li>
                        <li><a href="" class="text-white text-decoration-none">Cookies</a></li>
                        <li><a href="" class="text-white text-decoration-none">Cookies
                                preferences</a>
                        </li>
                        <li><a href="" class="text-white text-decoration-none">License agreement</a>
                        </li>
                ...
                <div class="col-4">
                    <ul class="list-unstyled">
                        ...
                        <li><a href="" class="text-white text-decoration-none">Tecnical support</a>
                        </li>
                    </ul>
                </div>
                <!-- /.col -->
