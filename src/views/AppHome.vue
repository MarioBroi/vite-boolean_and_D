        ...
        <div class="back-gradient">
            ...
            <div class="container">
                <div class="row text-center home-text py-5">
                    ...
                    <div>
                        <a href="" class="btn btn-lg border-danger home-text px-5 py-3">
                            Update characters
                        </a>
                    </div>
                </div>
                ...
                <div class="row text-center home-text py-5">
                    ...
                    <p class="fw-bold fs-4">
                        Stay updated with the latest news, updates, and articles from the world of Boolean & Dragons.
                        From
                        new
                ...
                <div class="row text-center home-text py-5">
                    ...
                    <p class="fw-bold fs-4">
                        ...
                        Join thousands of other players and dungeon masters in our forums, participate in community
                        events,
                        and
                        share your love for roleplaying games.
                    </p>
                    <div>
                        <a href="" class="btn btn-lg border-danger home-text px-5 py-3 fw-bold fs-4">
                            Sign In
                        </a>
